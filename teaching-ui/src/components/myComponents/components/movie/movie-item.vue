<template>
  ...
  <div class="movie-item">
    <div v-on:mouseover="isHover = true" v-on:mouseleave="isHover = false">
      <!-- 海报 -->
      <a :href="movieInfoUrl">
        <img class="poster" src="@/assets/images/939.jpg">
      </a>
      <!-- 鼠标划过时的效果 -->
      <div class="movie-item-hover" v-if="isHover">
        <!-- 海报 -->
        <a href="/">
          <img class="poster-hover" src="@/assets/images/939.jpg">
          <!-- 鼠标划过时显示的信息 -->
          <div class="movie-hover-info">
            ...
            <div class="title-hover">
              <span class="name-tags">类型: </span>动作/爱情
            </div>
            <div class="title-hover">
              <span class="name-tags">主演: </span>张译/乔杉
            </div>
            <div class="title-hover">
