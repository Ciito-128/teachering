    ...
    <el-col :xs="12" :sm="12" :lg="8" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('messages')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="proCount" :duration="1" class="card-panel-num"/>
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="8" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('purchases')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="proCount1" :duration="1" class="card-panel-num"/>
        </div>
      </div>
    </el-col>
  </el-row>
  ...
  methods: {
    ...
    getUserList() {
      ...
      listTeaching(this.queryParamsPro).then(response => {
        this.proCount1 = response.total;
      });
      this.queryParamsPro.type = '00'
      listTeaching(this.queryParamsPro).then(response => {
        this.proCount = response.total;
      });
    },
  }
}
